          ...
          <>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <iframe
                  src={`https://player.twitch.tv/?channel=${channelName}&parent=${typeof window !== 'undefined' ? window.location.hostname : 'heycasi.com'}&parent=localhost&muted=false`}
                  style={{
                    position: 'absolute',
                    top: 0,
                    left: 0,
            ...
            <div style={{
              ...
              {/* Right Column (40%) - Top Chatters + Questions */}
