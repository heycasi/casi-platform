  ...
  const socialLinks = [
    {
      name: 'Discord',
      description:
        'Join our Discord community for real-time support, feature discussions, and connecting with other streamers',
      icon: '💬',
    ...
    },
    {
      name: 'Twitter/X',
      description:
        'Get the latest updates, announcements, and engage in conversations about streaming',
      icon: '🐦',
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8">
            {socialLinks.map((social, index) => (
              <div
                key={index}
                className={`${social.bgColor} rounded-2xl p-8 border-2 border-gray-100 hover:border-gray-200 transition-colors`}
              >
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Beta users get exclusive access to our private Discord channels and direct line to our
            development team.
          </p>
          ...
          <Link
            ...
            data-event="cta-community-join-free"
          >
            Start Free Now
          </Link>
        </div>
